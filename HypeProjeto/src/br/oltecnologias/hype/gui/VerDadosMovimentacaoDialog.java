...
public class VerDadosMovimentacaoDialog extends java.awt.Dialog {
    ...
    /**
     * Creates new form VerDadosMovimentacaoDialog
     */
    public VerDadosMovimentacaoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VerDadosMovimentacaoDialog dialog = new VerDadosMovimentacaoDialog(new java.awt.Frame(), true);
