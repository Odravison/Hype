...
public class VerDadosVendaDialog extends java.awt.Dialog {
    ...
    /**
     * Creates new form VerDadosVendaDialog
     */
    public VerDadosVendaDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VerDadosVendaDialog dialog = new VerDadosVendaDialog(new java.awt.Frame(), true);
