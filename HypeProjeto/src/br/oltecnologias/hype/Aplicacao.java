...
import br.oltecnologias.hype.dao.ClienteJpaController;
import br.oltecnologias.hype.dao.DadosConfiguracaoJpaController;
import br.oltecnologias.hype.dao.MedidasJpaController;
...
public class Aplicacao {
    ...
    public static void main(String[] args) throws DocumentException, IOException, Exception {
        ...
        DadosConfiguracaoJpaController confJpa = new DadosConfiguracaoJpaController(emf);
        ...
        try {
            ...
            confJpa.create(config.getDados());
            System.out.println(confJpa.getDadosConfiguracaoCount());
            confJpa.destroy(config.getId());
            System.out.println(confJpa.getDadosConfiguracaoCount());
            confJpa.create(config.getDados());
            config.setContratoOriginal("a");
            confJpa.edit(config.getDados());
