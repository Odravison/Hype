...
public class GerenciadorDeVenda {
    ...
    public Venda realizarVenda(List<Produto> produtos, float valor, String formaPagamento, Calendar dataVenda) {
        
        Venda venda = new Venda(produtos, valor, formaPagamento, dataVenda);
